(async function () {
  ...
  // It repeatedly takes the top conversation, leaves the group (if that option exists),
  // then deletes the chat, and moves to the next one until the inbox is empty.
  // To stop early, run:  window.__stopMarketplaceCleanup = true
